...
namespace ChatboxWebApp.Services
{
    /// <summary>
    ...
    public class ChatGptService
    {
        ...
        /// <summary>
        /// Gets the current question count in the conversation.
        /// </summary>
        public int GetQuestionCount()
        {
            return _conversationHistory.Count(m => m is ChatRequestUserMessage);
        }

        /// <summary>
        /// Gets the maximum questions count allowed.
        /// </summary>
        public int GetMaxQuestionsCount()
        {
            return _config.MaxQuestionsCount;
        }
